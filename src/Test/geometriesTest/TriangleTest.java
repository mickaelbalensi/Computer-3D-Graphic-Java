...
class TriangleTest {
    /**
     * Test method for {@link geometries.Triangle#getNormal(Point3D pt)}.
     */
    @Test
    void getNormal() {
    ...
    public void testFindIntersections() {
        ...
        assertEquals(new Point3D(1.0d, 0.0d, 0.0d), p2,"TC02 : the Ray begin before the vertex of the Triangle");

        //TC03 : the Ray begin at the edge of the Triangle
        Ray r3 = new Ray(new Point3D(0.5d, 0.0d, 0.5d), new Vector(0.5d, 0.0d, 0.5d));
        Point3D p3 = t1.findIntersections(r3).get(0);

        assertEquals(new Point3D(0.5d, 0.0d, 0.5d), p3,"TC03 : the Ray begin at the edge of the Triangle");

        //TC04 : the Ray begin before the edge of the Triangle
        ...
        assertEquals(new Point3D(0.5d, 0.0d, 0.5d), p4,"TC04 : the Ray begin before the edge of the Triangle");

        //TC05 : the Ray begin at the extension of the edge of the Triangle
        Ray r5 = new Ray(new Point3D(0.0d, -1.0d, 2.0d), new Vector(-2.0d, -1.0d, 0.0d));
        assertNull(t1.findIntersections(r5),"TC05 : the Ray begin at the extension of the edge of the Triangle");

        //TC06 : the Ray begin before the extension of the edge of the Triangle
        Ray r6 = new Ray(new Point3D(1.0d, -0.5d, 2.0d), new Vector(-3.0d, -1.5d, 0.0d));
        assertNull(t1.findIntersections(r6),"TC06 : the Ray begin before the extension of the edge of the Triangle");

        //TC07 : the Ray begin at the plane anywhere
        ...
        assertNull(t1.findIntersections(r7),"TC07 : the Ray begin at the plane anywhere");

        //TC08 : the Ray begin on the Triangle
        Ray r8 = new Ray(new Point3D(-0.15d, -0.18d, 1.34d), new Vector(0.15d, -0.82d, -1.34d));
        assertNull(t1.findIntersections(r8),"TC08 : the Ray begin on the Triangle");

        //TC09 : the Ray begin between the extension of the edge of the Triangle
        ...
        assertEquals(p5, t2.findIntersections(r9),"TC09 : the Ray begin between the extension of the edge of the Triangle ");
 ...
 //       assertEquals(new Point3D(1.0d, 0.0d, 0.0d), p2,"wrong Test 2");
        ...
        Ray r3 = new Ray(new Point3D(0.5d, 0.0d, 0.5d), new Vector(0.5d, 0.0d, 0.5d));
        Point3D p3 = (Point3D) t1.findIntersections(r3);

        //assertEquals(new Point3D(0.5d, 0.0d, 0.5d), p3,"wrong Test 3 ");

        System.out.println("Test 4 : the Ray begin before the edge of the Triangle");
        Ray r4 = new Ray(new Point3D(0.0d, 0.0d, 0.0d), new Vector(1.0d, 0.0d, 1.0d));
        Point3D p4 = (Point3D) t1.findIntersections(r4);
