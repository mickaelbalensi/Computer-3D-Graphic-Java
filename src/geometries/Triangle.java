...
public class Triangle extends Plane {
    ...
    */
/**
     * Constructor for a triangle, receiving :
     * @param p1 First point (Point3D)
     * @param p2 Second point (Point3D)
     * @param p3 Third point (Point3D)
...
/**
    ...
    public Triangle(Point3D p1, Point3D p2, Point3D p3, Color color) {
        this(p1,p2,p3,color,new Material(0,0,0));
    }
    //endregion
